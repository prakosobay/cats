...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h1 class="h3 mb-2 text-gray-800 text-center">Edit Food</h1>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('update.food', $get->id )}}" method="POST" class="validate-form">
            @csrf
            <div class="card-body" id="input-container">
                <div class="row">
                    <div class="form-group">
                        <label for="name" class="form-label"><b>Name :</b></label>
                        <input type="name" name="name" value="{{ $get->name }}" class="form-control" id="name" required autofocus>
                    </div>
                </div>
            </div>
