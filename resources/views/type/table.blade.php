...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h1 class="h3 mb-2 text-gray-800 text-center">Table Types</h1>
                ...
                <tbody class="isi-table text-center">
                    @foreach ( $types as $type )
                        <tr>
                            ...
                            <td>{{ $type->name }}</td>
                            <td>
                                <a href="{{ route('edit.type', $type->id)}}" class="btn btn-sm btn-success mx-1 my-1" ><i class="glyphicon glyphicon-edit"></i>Edit</a>
                                <form action="{{ route('delete.type',$type->id) }}" method="POST" onsubmit="return confirm('Are You Sure Want to Delete This Data ?')" >
                                    @csrf
